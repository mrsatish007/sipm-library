          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: '32px', fontWeight: '700', color: '#002B5B', marginBottom: '5px' }}>125</div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '40px', marginBottom: '10px' }}>✅</div>
                <div style={{ fontSize: '32px', fontWeight: '700', color: '#4CAF50', marginBottom: '5px' }}>85</div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '40px', marginBottom: '10px' }}>📖</div>
                <div style={{ fontSize: '32px', fontWeight: '700', color: '#FFC107', marginBottom: '5px' }}>32</div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '32px', fontWeight: '700', color: '#f44336', marginBottom: '5px' }}>8</div>
